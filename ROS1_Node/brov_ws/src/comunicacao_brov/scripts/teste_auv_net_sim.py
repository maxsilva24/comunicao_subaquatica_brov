...
if __name__ == "__main__":
    # nome_arquivo = '/home/max/comunicao_subaquatica_brov/ROS1_Node/brov_ws/src/comunicacao_brov/scripts/Routing.conf'
    nome_arquivo = './src/comunicacao_brov/scripts/Routing.conf'
